...
servidor <-rsDriver(browser = "firefox", port = 5622L) 
cliente <- servidor$client              
cliente$navigate("https://www.familysearch.org/es/") 

# Inicio
iniciar_sesion <- cliente$findElement(using = "xpath", '//*[@id="signInLink"]')
...
# Guardamos
write.csv2(bernasconi_1895,'./data/bernasconi_1895.csv', row.names = F)
saveRDS(bernasconi_1895,'./data/bernasconi_1895.rds')
